...
English — only their descriptions and the DM-refusal message translate (a DM
handled as an invite link, see "Architecture" above, gets no reply at all,
